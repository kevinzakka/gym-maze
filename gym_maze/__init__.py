...
register(
    id="maze-sample-5x5-v0", entry_point="gym_maze.envs:MazeEnvSample5x5", max_episode_steps=2000,
)
...
register(
    id="maze-sample-3x3-v0", entry_point="gym_maze.envs:MazeEnvSample3x3", max_episode_steps=1000,
)
